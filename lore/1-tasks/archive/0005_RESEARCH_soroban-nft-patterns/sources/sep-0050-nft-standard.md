---
url: 'https://raw.githubusercontent.com/stellar/stellar-protocol/master/ecosystem/sep-0050.md'
title: 'SEP-0050: Non-Fungible Token Standard'
...
- The `transfer()` function exists in ERC20 but is absent in ERC721, primarily for historical reasons. In both ERC20 and ERC721, `transferFrom()` can be used instead of `transfer()`, with the only difference being an additional on-chain check. To avoid redundancy, `transfer()` was omitted from the ERC721 standard.
