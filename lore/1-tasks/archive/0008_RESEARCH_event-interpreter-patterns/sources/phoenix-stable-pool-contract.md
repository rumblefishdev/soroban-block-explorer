# Phoenix Protocol: Stable Pool Contract (Swap Events)

**Source:** https://github.com/Phoenix-Protocol-Group/phoenix-contracts/blob/main/contracts/pool_stable/src/contract.rs
**Fetched:** 2026-03-27
...
impl StableLiquidityPoolTrait for StableLiquidityPool {
    ...
    fn revoke_admin_change(env: Env) -> Result<(), ContractError> {
        ...
        env.events()
            .publish(("Stable Pool: ", "Undo admin change: "), ());
