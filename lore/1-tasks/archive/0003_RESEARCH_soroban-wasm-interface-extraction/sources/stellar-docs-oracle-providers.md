...
Publicly available free price oracles are compatible with [SEP40](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0040.md) ecosystem standard interface. Learn how to integrate Reflector feeds [in their documentation](https://reflector.network/docs).
