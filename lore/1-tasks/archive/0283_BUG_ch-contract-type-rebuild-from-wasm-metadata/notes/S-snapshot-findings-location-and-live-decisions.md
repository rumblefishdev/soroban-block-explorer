...
| G4  | SAC skeleton overrides                 | **covered** (`prepare_with_sac_overrides`, version-0 sentinel + stub-suppression)                                                                                                                                                                                       | —                                    | no                                                                            | —                                |
...
| G8  | first_seen-class watermarks            | RMT drifts to latest (cross-part backfill artifact)                                                                                                                                                                                                                     | repair-tier1 (MIN from facts)        | yes, but **stays batch**                                                      | every ledger                     |
| G9  | routing vs prior-ledger verdicts       | quarantine-first                                                                                                                                                                                                                                                        | reclassify drains                    | not for correctness (backstop drains); needed to stop pending inflow — Add. 3 | common                           |
