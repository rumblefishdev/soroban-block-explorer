...
title: 'Serverless | NestJS - A progressive Node.js framework'
...
> **Hint** To speed up development cycles, we install the `serverless-offline` plugin which emulates AWS Lambda and API Gateway.
...
> **Hint** For creating multiple serverless functions and sharing common modules between them, we recommend using the CLI Monorepo mode.
