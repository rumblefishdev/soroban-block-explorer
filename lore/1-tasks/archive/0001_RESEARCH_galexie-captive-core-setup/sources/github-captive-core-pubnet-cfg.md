---
url: 'https://github.com/stellar/go-stellar-sdk/blob/main/ingest/ledgerbackend/configs/captive-core-pubnet.cfg'
title: 'Captive Core Public Network Configuration'
fetched_date: 2026-03-25
task_id: '0001'
---

# Captive Core Public Network Configuration

**Source:** https://github.com/stellar/go-stellar-sdk/blob/main/ingest/ledgerbackend/configs/captive-core-pubnet.cfg
**Fetched:** 2026-03-25

> **WARNING!** Do not use this config in production. Quorum sets should be carefully selected manually.
...
This configuration initializes Stellar Captive Core for the public (mainnet) network. Key settings:

- **Network passphrase:** `Public Global Stellar Network ; September 2015`
- **`FAILURE_SAFETY=1`** — network can progress with up to 1 validator down
- **`HTTP_PORT=11626`** — Captive Core HTTP management port
- **`PEER_PORT=11725`** — Captive Core peer-to-peer port
- **7 home domains** all with `QUALITY="HIGH"`: publicnode.org, lobstr, franklintempleton.com, satoshipay, stellar.creit.tech, sdf, blockdaemon
- **21 validators** from 7 organizations, providing geographic and organizational diversity

### Validator organizations

| Organization       | Validators                                            | Nodes |
| ------------------ | ----------------------------------------------------- | ----- |
| PublicNode         | bootes, lyra, hercules                                | 3     |
| LOBSTR             | lobstr_1_eu, lobstr_2_eu, lobstr_5_india              | 3     |
| Franklin Templeton | FT_SCV_1, FT_SCV_2, FT_SCV_3                          | 3     |
| SatoshipPay        | satoshipay_de, satoshipay_sg, satoshipay_us           | 3     |
| Creit Tech         | Alpha, Beta, Gamma                                    | 3     |
| SDF                | SDF 1, SDF 2, SDF 3                                   | 3     |
| Blockdaemon        | blockdaemon_1, blockdaemon_2, Blockdaemon Validator 3 | 3     |
