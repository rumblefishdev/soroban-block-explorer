---
url: 'https://github.com/stellar/stellar-galexie/blob/main/config/config.example.toml'
title: 'stellar-galexie config.example.toml'
fetched_date: 2026-03-25
task_id: '0001'
image_count: 0
---

# stellar-galexie config.example.toml
