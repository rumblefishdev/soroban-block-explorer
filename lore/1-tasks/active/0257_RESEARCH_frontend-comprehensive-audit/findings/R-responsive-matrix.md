...
acceptance bar, keep a separate enhancement finding open; but the *responsive-failure*
...
- Queue card **8.3** responsive root cause → its *scrollWidth/802px* portion is DONE.
