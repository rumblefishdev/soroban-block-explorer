...
- **A3 (Wave 1 archaeology — 25/28 Future Work items un-spawned):** task-process gap — Future Work items in archived tasks have no spawning automation. Phase 3 sub-phase 3.2 is the bulk-spawn step but the *system* does not enforce. Out of scope here; flagged for 3.5 wiki write-up.
