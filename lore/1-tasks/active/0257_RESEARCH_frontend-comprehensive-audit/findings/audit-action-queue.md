...
- [x] **NetworkToggle no-op confirm** — MOOT: toggle deleted entirely (card 11.1, `e9122732`); nothing to verify (F-DP-1 / F-AN-6).
...
**Notes:** F-AI-4 / F-AI-9 / F-AI-11 informational; do not need own fix.
...
**Notes:** RESOLVED 2026-05-28 per user — chose Option B taken to the limit: the `NetworkToggle` component + its AppShell/TopNav wiring were **deleted entirely** (commit `e9122732`), not just hidden. Single-network explorer, no switcher in scope. Restores the honest single-environment baseline. The "NetworkToggle no-op confirm" verification item (top of queue) is now moot — nothing to verify. F-W6-AG-3's NetworkToggle-transition sub-point is likewise moot.
...
| F-AN-6                                         | 4             | 🟢      | C 6.4 / C 11.1          | TODO        | Mainnet/Testnet config single-env — regression UNWOUND: NetworkToggle deleted (`e9122732`, card 11.1). Back to plain scope: document single-environment `VITE_API_BASE_URL` config under card 6.4. No decorative toggle left to explain |
...
| F-W6-V-1                                       | 6             | 🟠      | C 7.2                   | PARTIAL     | LiveIndicator pills now LIVE/DELAYED/OFFLINE (`2c31a87a`); footer DM-1 still static                                                                                                                                                     |
...
| F-W6-E1-1                                      | 6             | 🟡      | C 7.2                   | PARTIAL     | Latest tx/ledger pills now DELAYED/OFFLINE when stale/errored (`2c31a87a`)                                                                                                                                                              |
...
| F-DP-1                                         | design_parity | 🟠      | C 11.1                  | RESOLVED    | NetworkToggle deleted entirely (`e9122732`) per user — Option B to the limit. No fake toggle left; honest single-environment baseline restored. See card 11.1                                                                           |
