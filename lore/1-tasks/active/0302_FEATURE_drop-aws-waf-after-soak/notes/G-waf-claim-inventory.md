...
| File                               | Hits | What to do                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/deployment.md`               | 6    | Stack table row `CloudFrontWaf … (no target — see gotcha)` and the matching gotcha document how to **deploy** it; nothing documents how to **delete** it. Drop the row — the stack is gone from the app — and rewrite the gotcha as the general lesson: CDK cannot delete a stack once its code leaves the app definition, and an unreleased cross-region export claim fails the delete.                    |
...
| `infra/README.md`                  | 1    | Stack list line `CloudFrontWafStack  CloudFront WebACL (conditional on enableWaf)`. Drop the row entirely — neither the stack nor the flag exists after this task.                                                                                                                                                                                                                                          |
