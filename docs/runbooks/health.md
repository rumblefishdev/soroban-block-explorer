...
| Galexie disk fills                                                | ✅ `galexie-ephemeral-storage` (level; re-arm = act before ceiling)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Container Insights %                 | ECS logs                                              | ➖ measured 26.5-30.5% across 57 days, never past 40% - a flat line; the 60% alarm guards a catchup spike, not this baseline |
...
| Costs step-change                                                 | 🔜 Cost Anomaly Detection → SNS ([costs.md](./costs.md))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | billing data                         | —                                                     | ➖ by design - reading note beside the cost graph says why                                                                   |
...
| Origin-lock canary trips (a direct origin answers instead of 403) | ➖ flag-gated OFF in production (`enableOriginLockCanary: false`); pages when armed, and would then have no widget                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Synthetics canary                    | canary run logs                                       | ➖ — arm the canary before giving it one                                                                                     |
| Frontend errors                                                   | ➖ out of the umbrella's scope (task 0087 owns it when activated)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | —                                    | —                                                     | ➖                                                                                                                           |
| Slack delivery chain itself breaks                                | ➖ DECIDED 2026-08-19 — ADR 0054 rule 5: the alarm stack's deploy is not finished until one message is seen in the channel. Chosen because a deploy is what broke it (2026-08-18/19: a topic-policy change revoked CloudWatch's publish right and every alarm action failed, found by accident; the 2026-08-19 repair was checked by reading the policy and did not work, so the mute actually ran nine days and 18 actions before the 2026-08-27 delivery test caught it). Email co-subscriber rejected — the denial was above the subscribers. Dead-man's-switch named, not adopted | —                                    | —                                                     | ➖                                                                                                                           |
