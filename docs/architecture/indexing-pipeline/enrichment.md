...
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Task**                | 0195 §2d                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Producer hook**       | Insert-hook: after commit, SELECT `nfts.id WHERE minted_at_ledger = ANY(...) AND (name IS NULL OR media_url IS NULL OR collection_name IS NULL)`. Re-emits if ANY of the three columns are still NULL (covers DLQ-resurfaced rows the worker partially populated). The producer emits exactly once per `nft_id` under normal operation                                                                                                                                                                                                                                                          |
...
| **Token id assumption** | `ScVal::U32` — OpenZeppelin / ERC-721 sequential-mint-counter convention. Token ids that don't parse as `u32` surface as `MalformedInput { field: "token_id (not u32)", … }` and land in the DLQ as a permanent fail                                                                                                                                                                                                                                                                                                                                                                          |
