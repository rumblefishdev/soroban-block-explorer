...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Task**                | 0195 §2d                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Producer hook**       | Per indexer batch: the NFTs the parser saw minted in that batch (an in-batch fact — `nfts` stores no mint ledger since task 0497), filtered by an anti-join on `nft_enrichment`. The producer emits exactly once per `nft_id` under normal operation; all three columns are checked so a partial-fill row (e.g. sentinel on one column, NULL on another from a flap) re-emits until every column lands a value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
