...
| `collection_name`  | `nfts.collection_name`                                      | `idx_nfts_collection`, `idx_nfts_collection_trgm` | indexer (declared) — actually **L2 nft** in practice (see §3 F4) | 1 088 584 / 0 / 0 | 1 087 583 / 1 001 / 0  | OK (only Bachini fixture had no collection_name in JSON)                                                                                                              |
...
- **F4** — DOCS: clarify `nfts.collection_name` ownership in schema doc + migration comment.
