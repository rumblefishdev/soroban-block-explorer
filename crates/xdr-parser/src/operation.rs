...
pub fn extract_operations(
    ...
    ops.iter()
        ...
        .map(|(i, op)| {
            ...
            let counterparties = extract_counterparties(&op.body, op_result);
...
///   redundant result). Success-gated upstream by [`tx_op_results`];
...
mod tests {
    ...
    // --- extract_counterparties (task 0359 F-C / K1-5) ---
