...
**Timestamp:** 2026-04-28T19:03:18Z
...
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/02_transactions.sql:32: ERROR:  could not resize shared memory segment "/PostgreSQL.46259564" to 134483968 bytes: No space left on device
...
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/03_transaction_hash_index.sql:16: ERROR:  could not resize shared memory segment "/PostgreSQL.1950014978" to 16777216 bytes: No space left on device
...
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/04_operations_appearances.sql:17: ERROR:  could not resize shared memory segment "/PostgreSQL.3089336634" to 134483968 bytes: No space left on device
...
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/05_transaction_participants.sql:16: ERROR:  could not resize shared memory segment "/PostgreSQL.850647304" to 134483968 bytes: No space left on device
...
### I1 — contract_id matches StrKey shape (56 chars, prefix C, base32)
 violations |                                                                                                             sample                                                                                                             
------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
          4 | {CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFLTRNFT,CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFLTRFUN,CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAASAC,CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAANFT}
(1 row)
...
### I1 — composite FK to transactions valid
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/08_soroban_events_appearances.sql:17: ERROR:  could not resize shared memory segment "/PostgreSQL.3252205770" to 134483968 bytes: No space left on device
...
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/08_soroban_events_appearances.sql:35: ERROR:  could not resize shared memory segment "/PostgreSQL.35363508" to 134483968 bytes: No space left on device
...
### I1 — composite FK to transactions valid
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/09_soroban_invocations_appearances.sql:11: ERROR:  could not resize shared memory segment "/PostgreSQL.1120815166" to 134483968 bytes: No space left on device
### I2 — contract_id FK to soroban_contracts valid
 violations 
------------
          0
...
psql:/Users/stkrolikiewicz/Developer/RumbleFish/soroban-block-explorer/crates/audit-harness/sql/09_soroban_invocations_appearances.sql:29: ERROR:  could not resize shared memory segment "/PostgreSQL.2083904302" to 134483968 bytes: No space left on device
...
### I1 — account_id matches StrKey shape (G or M prefix, 56 or 69 chars, base32)
 violations |                                                                                                                                         sample                                                                                                                                         
------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
       1336 | {GAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAASRC,GAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAASAC160ISS,GAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADST,GAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAISSUER,CCQTGB3YIFHAGPNR7RFDKGW3IPPKQOVUAED6KJFIFTQ5ZWAWEM2FB7UO}
(1 row)
...
### I3 — asset_a < asset_b ordering enforced (Stellar canonicalises pair order)
 violations |                                                                                                                                                                 sample                                                                                                                                                                 
------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
         40 | {0cd81ba8d81b08d0fc0141846925405d8757441fe69841570da01b8e7a08638b,1247b18e66135d6c995acd82e91fee5ebb399941ed259f46b7f82f92edd75a7f,1d061373985b2112d3cf20767c81fb7be6178eb8dec9f6f99cc736fbe5323650,202452010cd045a8449873ce57019c1bf605b944cf5c8275b6bb7ca206d038dc,33375ac45ba25e41e68acb2fed9dbecc6feecf7d8fffeb8644ef2c1d73705fcd}
(1 row)
