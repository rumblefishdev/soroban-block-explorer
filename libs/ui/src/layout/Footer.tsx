  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box display="flex" flexDirection="column" gap={3} sx={{ width: 283 }}>
          <Box>{logo}</Box>
        ...
        <Box display="flex" flexDirection="column" gap={1} sx={{ width: 320 }}>
        ...
        {/* Right: Resources */}
        <Box display="flex" flexDirection="column" gap={1} sx={{ width: 244 }}>
          <Typography variant="heading6SemiBold" color="text.primary">
            Resources
          </Typography>
          <Box display="flex" flexWrap="wrap" gap={1}>
